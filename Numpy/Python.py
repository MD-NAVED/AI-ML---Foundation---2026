...
# @staticmethod #used to create the method which is not related to the class variable
# and can be called without creating the object of the class

# @classmethod #used to change the class variable without creating the object
# of the

# @instance #used to change the instance variable and can be called only by creating the object
# of the class
...
# @property = used to create the method which is related to the class variable
# and can be called by creating the object of the class


  # {Panding excersise} :-

#polymorphism = the ability of an object to take on many forms. It allows objects of different classes
# to be treated as objects of a common superclass. In Python, polymorphism is achieved through method overriding and duck typing.

#dunder method = a special method in Python that starts and ends with double underscores (__)
# and is used to define the behavior of an object for built-in operations.
# For example, the __str__ method
# is used to define how an object should be represented as a string when printed.
...
# (0:59:51).
# This class should have a showDetails() method (1:05:32).
# Create an Engineer class that inherits properties from Employee & has additional attributes: name & age (1:06:17).
